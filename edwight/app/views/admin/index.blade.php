...
<head>
    ...
    {{HTML::style('css/bootstrap.css')}}
     ...
     <!-- MORRIS CHART STYLES-->
     {{HTML::script('js/morris/morris-0.4.3.min.css')}}
        <!-- CUSTOM STYLES-->
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="{{HTML::image('img/find_user.png')}}" class="user-image img-responsive"/>
					</li>
                            ...
                            <ul class="chat-box">
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                        <img src="{{HTML::image('img/1.png')}}" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body">                                        
